...
public:
  ...
  IOManager(Params &params)
    : params(params), device_params(params.device_params), geometry(params.device_params), xdmf_str(init_xdmf_str())
    {
